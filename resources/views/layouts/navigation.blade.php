    ...
    <div class="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl">
        ...
        <div class="hidden w-full lg:flex lg:w-auto lg:order-1" id="navbar-default">
            <ul class="flex flex-col p-4 lg:p-0 mt-4 border border-gray-100 rounded-lg bg-gray-50 lg:flex-row lg:space-x-8 lg:mt-0 lg:border-0 lg:bg-white dark:bg-gray-800 lg:dark:bg-gray-900">
                ...
                <li><a href="/pets" class="block py-2 px-3 text-gray-700 hover:bg-gray-100 lg:hover:bg-transparent lg:hover:text-blue-700">Groomer</a></li>
                <li><a href="/services" class="block py-2 px-3 text-gray-700 hover:bg-gray-100 lg:hover:bg-transparent lg:hover:text-blue-700">Clinic</a></li>
                <li><a href="/contact" class="block py-2 px-3 text-gray-700 hover:bg-gray-100 lg:hover:bg-transparent lg:hover:text-blue-700">Shelter</a></li>
